...
def main(label, model,special_tokens,device,tokenizer):
    ...
    outputs = model.generate(
        ...
        pad_token_id=0,
           do_sample=True,
           num_return_sequences=2)#num_return_sequences=20) # Depending non your GPU, you'll be able to generate fewer or more sequences. This runs in an A40.
...
if __name__=='__main__':
    device = torch.device("cuda")  # Use Metal Performance Shaders on Mac M1
    ...
    # tokenizer = AutoTokenizer.from_pretrained('/Users/mo2016/Documents/other_projects/sota_hackathon/ZymCTRL/') # change to ZymCTRL location
    # model = GPT2LMHeadModel.from_pretrained('/Users/mo2016/Documents/other_projects/sota_hackathon/ZymCTRL').to(device) # change to ZymCTRL location
